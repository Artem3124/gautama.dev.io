...
export const breathingPractices = [
    // id(0) - Everyday practice
    {
        ...
        imagePath: new URL("@/assets/img/end-peace.png", import.meta.url).href,
        reward: 33,
    },
    // id(1) - Everyday practice extended
    // rewrite image path as above for other practices
    {
        id: 1,
        name: "Filling Breath",
        pattern: [4, 4, 4, 0],
    ...
    // id(2) - Filling breath
    {
        ...
        imagePath: new URL("@/assets/img/end-base.jpeg", import.meta.url).href,
        reward: 33,
    },
    ...
    // id(4) - Chamomile breath
    {
        ...
        imagePath: new URL("@/assets/img/end-concentration1.png", import.meta.url).href,
        reward: 33,
    },
